package com.example.lucas.proyectofyg;
...
public class SampleMaterialAdapter extends RecyclerView.Adapter<SampleMaterialAdapter.ViewHolder> {
    ...
    public void addCard(String name, int color) {
        ...
        cardsList.add(card);
        ((sample) context).doSmoothScroll(getItemCount());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View v) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Pair<View, String> p1 = Pair.create((View) initial, sample.TRANSITION_INITIAL);
                    Pair<View, String> p2 = Pair.create((View) name, sample.TRANSITION_NAME);
                    Pair<View, String> p3 = Pair.create((View) deleteButton, sample.TRANSITION_DELETE_BUTTON);
                    ...
                    transitionIntent.putExtra(sample.EXTRA_NAME, name);
                    transitionIntent.putExtra(sample.EXTRA_INITIAL, Character.toString(name.charAt(0)));
                    transitionIntent.putExtra(sample.EXTRA_COLOR, color);
                    transitionIntent.putExtra(sample.EXTRA_UPDATE, false);
                    transitionIntent.putExtra(sample.EXTRA_DELETE, false);
